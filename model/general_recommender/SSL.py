...
class SSL(AbstractRecommender):
    def __init__(self, config):
        super(SSL, self).__init__(config)
    ...
    @timer
    def create_adj_mat(self, is_subgraph=False, aug_type='nan'):
    ...
    def train_model(self):
        data_iter = PairwiseSamplerV2(self.dataset.train_data, num_neg=2, batch_size=self.batch_size, shuffle=True)
